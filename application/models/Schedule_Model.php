...
public function fetch_schedule($id){
	...
	return $this->db->select('task_id,task_name,task_description,task_note,task_created_by,task_date,tbl_employee.employee_name')->from('tb_task')->join('tbl_employee','tbl_employee.employee_id=tb_task.task_created_by')->where($where)->get()->result();
}
