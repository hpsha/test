                ...
                <div class="container-fluid">
                    ...
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">ADD Machinery Subcategory</h5>
                        </div>
                        <!-- Breadcrumb -->
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>ADD Machinery Subcategory</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                    </div>
                            ...
                            <div class="panel card-view">
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class="form-wrap">
                                            <form data-toggle="validator" role="form" id="prd_type_form" action="<?php echo base_url(); ?>Master/subcategory_adddetails" method="POST">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-group">
                                        <input type="text" class="form-control" id="subcategory_name" name="subcategory_name" placeholder="Machinery Subcategory Name" data-validation="required" data-validation-error-msg="Please Enter Machinery Subcategory Name">
                                        <div class="input-group-addon"><i class="icon-user"></i></div>
                                        </div>
                                        </div>
									</div>
