        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Task Add</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
                        <li><a href="<?php echo base_url(); ?>Schedule/">Task List</a></li>
                        <li class="active"><span>Task Add</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                    ...
                    <div class="panel card-view">
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    <form data-toggle="validator" role="form" id="emp_form" action="<?php echo base_url(); ?>Task/adddetails" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                           
                                            <div class="form-group col-md-4">
                                                <label class="control-label mb-10" for="exampleInputuname_2">Task Name</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" data-validation="required" data-validation-error-msg="Please Enter Task Name" value="">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                       <textarea class="form-control" rows="2" id="schedule_des" name="schedule_des" placeholder="Task Description" data-validation="required" data-validation-error-msg="Please enter Task Description"></textarea>
                                                        <div class="input-group-addon"><i class="fa fa-sitemap"></i></div>
                                                    </div>
                                                </div>
												 <div class="form-group col-md-4">
                                                    <label class="control-label mb-10" for="exampleInputEmail_4">Task Assigned</label>
