                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    ...
                                    <form data-toggle="validator" role="form" id="emp_form" action="<?php echo base_url(); ?>Products/add_details" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                          <div class="col-md-3">
                                                <div class="example">
                                                    <label class="control-label mb-10 text-left"> Product Group</label>
                                                    <input type="text" class="form-control" placeholder="Product Group" name="group_name" data-validation="required">
                                                </div></div>
                                        </div>
										<span id="xx"></span>
                                        <div class="row">
