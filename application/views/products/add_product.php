                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    ...
                                    <form data-toggle="validator" role="form" id="emp_form" action="<?php echo base_url(); ?>Products/add_productdetails" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                          <div class="col-md-3">
                                                <div class="example">
                                                    ...
                                                    <select class="form-control" id="group_name" name="group_name"  data-validation="required">
                                                        ...
                                                        <option value="<?php echo $data->productgroup_id ?>"><?php echo $data->productgroup_name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div></div>
                                                <div class="col-md-3">
                                                <div class="example">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Product Name" name="product_name"  data-validation="required">
                                                </div></div>
                                        ...
                                        <div class="col-md-3">
                                            <input type="hidden" name="branch_id[]" value="<?php echo $dat->branch_id; ?>">                                                
                                                <div class="example">
                                        ...
                                        <div class="col-md-3">
                                                <div class="example">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Distributor Price" name="distributor_price[]"  >
                                                </div></div>  </div> 
                                         <?php } ?>				
                                        <div class="row">
