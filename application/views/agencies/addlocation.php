            ...
            <div class="row heading-bg">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url(); ?>Agencies/listlocation">Location List</a></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                    ...
                    <div class="panel card-view">
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    <form data-toggle="validator" role="form" id="emp_form" action="<?php echo base_url(); ?>Agencies/addnewlocation" method="POST" enctype="multipart/form-data">
