        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Location Edit</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
                        <li><a href="<?php echo base_url(); ?>Agencies/location">Location List</a></li>
                        <li class="active"><span>Location Edit</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-wrap">
                                   <?php 
                                      ...
                                      $employee=$this->db->query("select * from tbl_location where location_id=$lid")->row();
                                   
                                    ?>
                                   
                                    <form data-toggle="validator" role="form" id="emp_form" action="<?php echo base_url(); ?>Agencies/updatelocationdetails" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                          <div class="col-md-3">
                                               
                                            
												
                                                        <label class="control-label mb-10" for="exampleInputuname_2">Location Name</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value="<?php echo $employee->location_name;?>"id="l_name" name="l_name" placeholder="Location Name" data-validation="required" data-validation-error-msg="Please Enter Location Name">
