                ...
                <div class="panel panel-default card-view">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form action="<?php echo base_url(); ?>Orders/Search" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <?php
                                            $role=$_SESSION['userdata']['type'];
                                            $id=$_SESSION['userdata']['emp_id'];
                                            if($role==4){
                                            $mss = $this->db->query("select sum(price) as t from tbl_order where  date(`created_on`) between '$from' and '$to' and shop_type!=3 and agencies_id=$id")->row();
                                            }
                                            if($role==1){
                                            ...
                                            if($role==4){
                                                 $mss = $this->db->query("select sum(price) as t from tbl_order where  created_on='$date' and shop_type!=3 and agencies_id=$id ")->row();
                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table id="orderw" class="table table-hover display  pb-30" >
                                        <thead>
                                            <tr>
                                                 <th> Order No</th>
                                                <th> Agent</th>
