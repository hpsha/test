                                                ...
                                                <div class="profile-box">
                                                    ...
                                                    <div class="social-info">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-6 text-center">
                                                                <span class="counts block head-font"><span class="counts-text block" style='font-size: 12px;margin-top: 13px;'>
                                                                    <?php  if($shop_view[0]->shop_type==1){ echo "Retailer";} 
                                                    ...
                                                    <div class="col-md-6">
                                                        <button class="btn btn-default btn-block btn-outline btn-anim mt-30" onclick="window.location.href = '<?php echo base_url(); ?>Shop_list/shop_view_pdf/<?php echo $shop_id ?>'"><i class="fa fa-arrow-down"> Download </i><span class="btn-text">Download</span></button>
                                                    </div>
                                                        </div>
