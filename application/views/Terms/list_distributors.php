    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">List Orders</h5>
            </div>
            <!-- Breadcrumb -->
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
                    <li class="active"><span>List Orders</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
                                    ...
                                    <table id="example" class="table table-hover display  pb-30" >
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($shop as $shop_details) {
                                                ...
                                                $aas = $this->db->query("select agencies_name from tbl_agencies where agencies_id=$sid")->num_rows();
                                                ?>
                                                <tr>
                                                    <td><?php if ($aas > 0) {
                                                    echo $aa->agencies_name;
                                                } else {
                                                    echo "Others";
                                                } ?></td>

 <td><?php echo $shop_details->order_no; ?></td>                                                    <td><?php echo $shop_details->shop_name; ?></td>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        ?></td>
                                                    <td>RS.<?php
                                                        echo round($shop_details->t, 2);
                                                        ?></td>
                                                    <td><?php echo $shop_details->created_on; ?></td>
                                                    <td><?php
                ...
                echo $mails;
                                                    ...
                                                    <td class="text-nowrap">
                                                        <button onclick="window.location.href = '<?php echo base_url(); ?>Orders/order_view/<?php echo $shop_details->order_id ?>'" class="btn btn-info btn-icon-anim btn-circle" data-toggle="tooltip" data-original-title="View"> <i class="fa fa-eye"></i> </button>
                                                        <button onclick="window.location.href = '<?php echo base_url(); ?>Orders/order_view_pdf/<?php echo $shop_details->order_id ?>'" class="btn btn-info btn-icon-anim btn-circle" data-toggle="tooltip" data-original-title="Download"> <i class="fa fa-download"></i> </button>
