        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Employee group Edit</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
                        <li><a href="<?php echo base_url(); ?>Employee/group">Employee group List</a></li>
                        <li class="active"><span>Employee group Edit</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                                        ...
                                        <div class="row">
                                          <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value="<?php echo $employee->employee_group_name;?>"id="emp_name" name="emp_name" placeholder="Employee Group Name" data-validation="required" data-validation-error-msg="Please Enter Company Name">
                                         ...
                                         <div class="form-group col-md-3">
												...
												<select class="form-control" id="created_by"  multiple name="created_by[]"  data-validation="required" data-validation-error-msg="Please Select Assigned to">
                                                            ...
                                                            <?php  foreach ($employeem as $emp_data) { 
                                                                
                                                      ?>
                                                                <option value="<?php echo $iid=$emp_data->employee_id; ?>" <?php for($i=0;$i<$count;$i++){
                                                                    if($mmm[$i]==$iid){
                                                                        echo "Selected";
                                                                    }
                                                                 ...
                                                                 ?>><?php echo $emp_data->employee_name; ?>(<?php echo $emp_data->employee_email; ?>)</option>
                                                            <?php } ?>
                                                        </select>
                                                        <div class="input-group-addon"><i class="icon-user"></i></div>
                                                </div>
