                            ...
                            <div class="panel card-view">
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class="form-wrap">
                                            <form data-toggle="validator" role="form" id="emp_form" action="<?php echo base_url(); ?>Employee/update_user" method="POST" enctype="multipart/form-data">
                                                <?php 
                                                    if(!empty($employee) && $emp->employee_id != '')
                                                    {
                                                ?>
                                                <input type="hidden" name="employee_id" id="employee_id" value="<?php echo $emp->employee_id; ?>"/>
                                                <?php } ?>   
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        <label class="control-label mb-10" for="exampleInputuname_2">Name</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="emp_name" name="emp_name" placeholder="Name" value="<?php echo $emp->employee_name; ?>" data-validation="required" data-validation-error-msg="Please Enter the Name">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="emp_number" name="emp_number" placeholder="Enter Mobile Number" value="<?php echo $emp->employee_phone; ?>" data-validation="length number" data-validation-length="min10" maxlength="10" onkeypress="return isNumberKey(this.value)" >
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="email" class="form-control" id="emp_email" name="emp_email" placeholder="Enter email" data-validation="email" value="<?php echo $emp->employee_email; ?>" data-validation-error-msg="Please enter a valid e-mail" onkeyup="return checkEmployemail(this.value);">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="emp_pin" name="emp_pin" placeholder="Pincode" value="<?php echo $emp->employee_pincode; ?>" data-validation="length number" data-validation-length="6" data-validation-error-msg="Please enter Valid Pincode">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="employee_usertype" id="employee_usertype" class="form-control"  onchange="return userchanges(this.value);">
                                                                ...
                                                                <option value="2" <?php if($emp->employee_usertype == 2){echo "selected";} ?>>General Admin/ROTN</option>
                                                                <option value="3" <?php if($emp->employee_usertype == 3){echo "selected";} ?>>ASM/ASO</option>
                                                                <option value="5" <?php if($emp->employee_usertype == 5){echo "selected";} ?>>Sales Person/CSR</option>
                                                            </select>
                                                            <div class="input-group-addon"><i class="ti-user"></i></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-4"  id="userChange" style="<?php if($emp->employee_usertype == 3){ echo 'display: block'; }else{ echo 'display: none';} ?>">
                                                        ...
                                                        <div class="input-group">	
                                                            <select class="form-control" id="created_by"  multiple name="created_by[]"  data-validation="required" data-validation-error-msg="Please Select Assigned to">
                                                                <option value="">Please Select Assigned to</option>
                                                                    <?php  
                                                                    foreach ($agency as $emp_data) { ?>
                                                                 <option value="<?php echo $emp_data->agencies_id; ?>" <?php if(strpos($emp->employee_usertype, $emp_data->agencies_id) != false){echo "selected";}else{echo ""; } ?>><?php echo $emp_data->agencies_name; ?></option>
                                                                <?php } ?>
                                                        </select>
                                                        <div class="input-group-addon"><i class="icon-user"></i></div>
                                                </div>
   ...
   /*User Type */
    ...
    function checkEmployemail(str){
        ...
        $.ajax({
            ...
            success: function (data) {
               if(data != 0){
                   $("#email_errorMsg").show(); return false;
               }else{
                   $("#email_errorMsg").hide();
               }
            }
