                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table id="example" class="table table-hover display  pb-30" >
                                        ...
                                        <tbody>
                                            <?php $i=1; for($j=0;$j<$count;$j++){ ?>
                                            <tr>
                                                <td><?php echo $i++ ?></td>
                                                <td><?php echo $data[$j]['customer_name'] ?></td>
                                                <td><?php echo $data[$j]['customer_phone'] ?></td>
                                                <td><?php echo $data[$j]['customer_mail'] ?></td>
                                                <td><?php echo $data[$j]['customer_gst_no'] ?></td>
                                                <td><?php echo $data[$j]['customer_spindles'] ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
