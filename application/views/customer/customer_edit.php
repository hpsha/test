<body>
        ...
        <div class="col-sm-12">
          <div class="panel panel-default card-view">
			...
			<?php $data=$customer_detail; ?>
               <form id="edit_customer" class="customer_edit_form" name="form" action="<?php echo base_url(); ?>Customer/customer_edit" method="POST">
					<h3>
                          ...
                          <div class="row">
                           ...
                           <div class="row">
                            <div class="form-group col-md-4">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control required" id="customer_gst_no"  onKeyPress="return AlphaNumberKey(event)" name="customer_gst_no" placeholder="GST No" data-validation="required" data-validation-error-msg="Please Enter GST No" pattern="[A-Z0-9]{15}" maxlength="15" value="<?php echo $data->customer_gst_no; ?>">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-1 col-md-1">
                                    ...
                                    <div class="checkbox checkbox-success">
                                       ...
                                       <input class="agent_through" id="agent_through<?php echo $i; ?>" type="checkbox" name="customer_through[]" value="2" 	<?php
                        ...
                        <div class="form-wrap">
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control required" id="billing_gst_no"  onKeyPress="return AlphaNumberKey(event)" name="billing_gst_no" placeholder="GST No" data-validation="required" data-validation-error-msg="Please Enter GST No" value="<?php echo $data->customer_billing_gst; ?>">
                                <div class="input-group-addon"><i class="icon-notebook"></i></div>
                              </div>
                            </div>
                          </div>
  ...
  <script src="<?php echo base_url('app-assets/dist/js/form-wizard-data1.js');?>"></script>
